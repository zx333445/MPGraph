...
from torch_geometric.nn import global_mean_pool, global_max_pool, AttentionalAggregation, GlobalAttention


class WiKG(nn.Module):
    def __init__(self, dim_in=1024, dim_hidden=512, topk=6, n_classes=4, agg_type='bi-interaction', dropout=0.3, pool='attn'):
        super().__init__()
        ...
        if pool == "mean":
            ...
            # self.readout = AttentionalAggregation(att_net)
